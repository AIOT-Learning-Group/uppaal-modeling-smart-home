...
async def filter_interactive_system(request: Request, model: str = Body(...)) -> str:
...
async def filter_controller_models(request: Request, model: str = Body(...)) -> str:
...
async def load_time_automaton(request: Request, name: str, model: str = Body(...)) -> str:
