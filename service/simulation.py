...
async def submit_simulation_params(request: Request) -> Union[str, Dict[str, str]]:
    try:
        simulation = await parse_simulation_params(await request.json())
...
async def parse_simulation_params(raw_params: Tuple[List[Dict[str, str]], List[Dict[str, str]], str, str]) -> Simulation:
